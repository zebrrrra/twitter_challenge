...
const AuthInput = ({ label, id, type, placeholder, value, maxLength, onChange, height = 54, responseError, errorInfo, name }) => {
  ...
  return (
    <>
      <div className={inputStyle} style={containerStyle}>
        ...
        <input type={type} name={name} className={style.input} id={id} placeholder={placeholder} value={value} onChange={(e) => onChange(e.target.value)} />
      </div>
